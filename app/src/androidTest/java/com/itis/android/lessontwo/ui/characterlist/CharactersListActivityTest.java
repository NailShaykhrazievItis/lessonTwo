...
public class CharactersListActivityTest {
    ...
    @Rule
    public final ActivityTestRule<CharactersListActivity> rule = new ActivityTestRule<>(CharactersListActivity.class);
    ...
    public void testClickOnItem() throws Exception {
        ...
        Intents.intended(hasComponent(CharactersActivity.class.getName()));
    }
