...
public class CharactersListEmptyActivity {

    @Rule
    public final ActivityTestRule<CharactersListActivity> rule
            = new ActivityTestRule<>(CharactersListActivity.class,false,false);
    ...
    public void testErrorDisplayed() throws Exception{
        ...
        onView(withId(R.id.tv_empty)).check(matches(withText(R.string.text_empty_characters)));
    }
